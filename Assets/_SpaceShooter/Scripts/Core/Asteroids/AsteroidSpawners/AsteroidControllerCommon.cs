...
{
    [Injectable]
    public class AsteroidControllerCommon : IAsteroidController
    {
        private const string PrefabPath = "Prefabs/Core/Asteroids/Asteroid_Common";

        private Pool<Asteroid> _asteroidsPool;

        private float _spawnAreaX = 2f;
        private float _spawnPosY = 6f;
        private float _asteroidSpeed = -1.5f;
        ...
        public string GetAsteroidType() => AsteroidTypes.Common;
