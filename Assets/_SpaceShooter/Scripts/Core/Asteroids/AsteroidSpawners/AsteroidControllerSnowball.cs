...
{
    [Injectable]
    public class AsteroidControllerSnowball : IAsteroidController
    {
        private const string PrefabPath = "Prefabs/Core/Asteroids/Asteroid_Snowball";
        ...
        public string GetAsteroidType() => AsteroidTypes.Snowball;
        ...
        public Asteroid SpawnAsteroid()
        {
            ...
            asteroidTr.localScale = Vector3.one;
            ...
            void AtUpdate(Unit unit)
            {
                ...
                var upscale = Time.deltaTime * _sizeStep;
                asteroidTr.localScale += Vector3.one * upscale;
            }
